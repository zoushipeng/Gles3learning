...
#define NATIVE_RENDER_CLASS_NAME "com/fujica/gles3learning/selfView/MyNativeRender"
...
#endif
/*
 * Class:     com_fujica_gles3learning_selfView_MyNativeRender
 * Method:    native_OnInit
 * Signature: ()V
 */
JNIEXPORT void JNICALL native_OnInit(JNIEnv *env, jobject object){
 ...
 * Signature: ()V
 */
JNIEXPORT void JNICALL native_OnUnInit(JNIEnv *env, jobject object){
 ...
 * Signature: ()V
 */
JNIEXPORT void JNICALL native_OnSurfaceCreated(JNIEnv *env, jobject object){
